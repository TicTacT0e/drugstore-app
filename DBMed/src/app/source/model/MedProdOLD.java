...
public class MedProdOLD implements Serializable{
    ...
    public MedProdOLD(int medCode, String nameMed, String indications, String unit, int quantityInPac, String manufactName) {
